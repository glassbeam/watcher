...
public enum Event {
    ...
    /**
     * Meta-event combining {@link #Moved_From} and {@link #Moved_To}. Only occurres
     * in the BufferedRecursiveWatcher.
     */
    Moved_From_To(0x00001000),
    ...
    All(Access.value | Close.value | Create.value | Delete.value | Delete_Self.value | Metadata.value | Modify.value | Move_Self.value
            | Moved.value | Moved_From_To.value | Open.value);
     ...
     * false} otherwise.
     * 
     * @param e Event such that the statement, {@code e.value & mask}, returns
